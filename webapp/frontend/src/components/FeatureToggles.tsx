    ...
    <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 px-2">
      ...
      {values.diarize && (
        <details className="relative">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-1 z-20 flex flex-col gap-2 bg-panel3 border border-border2 rounded-sm px-3 py-2 shadow-[0_8px_24px_rgba(0,0,0,.4)] min-w-[200px] max-w-[calc(100vw-16px)] max-h-[50vh] overflow-y-auto">
