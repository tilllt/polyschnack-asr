...
export function useRetranscribe() {
  ...
  return useMutation<Recording, Error, { id: string; opts?: { enable_vad?: boolean; enable_diarize?: boolean; diarize_num_speakers?: number; diarize_min_duration_off?: number; enable_streaming?: boolean; enable_noise_reduce?: boolean; enable_enhance?: string; backend?: string } }>({
