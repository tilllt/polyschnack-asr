...
def test_diarize_diagnosis_http_error():
    ...
    with patch("httpx.get") as mock_get:
        resp = httpx.Response(503, request=httpx.Request("GET", "http://crispr-crispr-diar:5098/health"))
...
def test_status_endpoint_has_diag_fields():
    ...
    with patch.object(m, "_diarize_diagnosis", return_value={
            "available": True, "code": "ok", "service": "http://crispr-crispr-diar:5098",
...
def test_status_endpoint_reports_unreachable():
    ...
    with patch.object(m, "_diarize_diagnosis", return_value={
            ...
            "service": "http://crispr-crispr-diar:5098",
